...
[gatherobs] = bj_Forward_PRE_co(recloc,srcloc,ng,nsrc,srcpulse,dx,ep,sig,mu,T,dt,dz,x,z,nnoise,parx,nt_wf,dt_wf,t,FWImode,bj1,bj2);
cd(:,:)=gatherobs(:,1,:);
...
%%
parfor isrc = 1:nsrc
    [ep_sse,mu_sse, sig_sse,xse,zse,zz] = Mr(bj1,bj2,srcloc,recloc,dx,ep_ss,mu_ss,sig_ss,isrc,lm);
     [forwavefield,gatherpre]=TMGenerateData(srcloc(zz,:),recloc(zz,:),  srcpulse1,T,isrc,ep_sse,mu_sse,sig_sse,dt,dx,dz,xse,zse,outstep,plotopt,dt_wf,nt_wf);
      ...
      joint_source=joint_source';
        bpwavefield=TMRunBackwardnew(recloc(zz,:),srcloc(zz,:),joint_source,T,isrc,ep_sse,mu_sse,sig_sse,dt,dx,dz,xse,zse,outstep,plotopt,t,dt_wf);
...
[a_dk1e,a_dk1] = Recon(nx,nz,nsrc,srcloc,recloc,bj1,bj2,dx,lm,a_dk11,a_dk1e1,a_illum1);
...
parfor isrc = 1:nsrc
      [ep11e,mu_sse,sig11e,xse,zse,zz] = Mr(bj1,bj2,srcloc,recloc,dx,ep11,mu,sig11,isrc,lm);
