function [wavefieldb,gather]=TMRunBackwardnew(srcloc,recloc,srcpulse,T,isrc,ep,mu,sig,dt,dx,dz,x,z,outstep, plotopt,t,dt_wf)
...
% run the simulation
tic;
[wavefieldb,gather,tout,srcx,srcz,recx,recz] = TM_model2dRTMnew(ep3,mu3,sig3,x3,z3,srcloc,recloc,srcpulse,t,npml,outstep,plotopt,x,z,dt_wf);
% %disp(' ');
...
% %save(['Gather02_',num2str(isrc),'.mat'],'gather')
% save(['Wavefield02_',num2str(isrc),'.mat'],'wavefieldb')
end
